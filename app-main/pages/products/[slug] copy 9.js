...
export default function ProductDetail() {
  ...
  // Function to randomly pick products from the weighted "allProducts" array
  const getRandomProducts = () => {
    ...
    setSelectedProducts(productCount);
  };

  // Similar to getRandomProducts but filters only sukkerfri products
  ...
  // Similar to getRandomProducts but filters only "med sukker" products
    ...
    <div className="flex flex-col items-center justify-center w-full h-full p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row items-start justify-center w-full max-w-4xl gap-8">
        ...
        <div className="flex-grow w-full">
          ...
          {/* Random product selection buttons for old links */}
          {!isMixPage && (
            <div>
              <button
          ...
          {/* Manual product selection for "mix" pages */}
          {isMixPage && (
            <div className="mt-4">
