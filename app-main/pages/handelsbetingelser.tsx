// /pages/handelsbetingelser.tsx

import React, { FC } from 'react';

const Handelsbetingelser: FC = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container mx-auto p-8">
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            Den første vare i fysisk besiddelse, når det drejer sig om regelmæssig levering af varer over en 
            bestemt periode.
          </li>
        </ul>
        ...
        <p>
          Du skal sende din ordre retur uden unødig forsinkelse og senest 14 dage efter, at du har gjort brug af din
          fortrydelsesret. Du skal afholde de direkte udgifter i forbindelse med returnering.
        ...
        <p>
          Hvis varen er prøvet udover det ovenfor beskrevne, betragtes den som brugt. Hvilket betyder, at du ved
        ...
        <p>
          ...
          2500 Valby
          Link:{' '}
          <a href="http://www.forbrug.dk" className="text-blue-500 hover:underline">
            www.forbrug.dk
          </a>
        </p>
        <p>
          ...
          <a href="http://ec.europa.eu/consumers/odr/" className="text-blue-500 hover:underline">
