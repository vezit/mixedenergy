...
interface BasketItem {
  quantity: number;
  // If your basket items have more fields, define them here
  // e.g. name: string, price: number, etc.
}

const Header: React.FC = () => {
  const { basketItems } = useBasket() as { basketItems: BasketItem[] };
  ...
  return (
    ...
    >
      <a href="/" className="flex items-center">
        {/* If using Next.js <Image>, you can replace with: 
