...
const computedChecksum = crypto
  ...
  if (computedChecksum === quickPayChecksumHeader) {
    console.log('Checksums match. The request is authentic.');
  } else {
    console.log('Checksums do not match. The request may have been tampered with.');
  }
